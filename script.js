 // Global state for theme
        ...
        // --- Coaches Widget ---
        const coaches = [
            { id: 1, name: 'Coach Balram', specialty: 'Strength Training', bio: 'Expert in weightlifting and muscle gain.', imageUrl: 'Balram.jpg' },
            { id: 2, name: 'Coach Gouri', specialty: 'Yoga & Mindfulness', bio: 'Helps with flexibility and mental well-being.', imageUrl: 'gouri.jpg' },
            { id: 3, name: 'Coach Ramdas', specialty: 'Nutrition', bio: 'Guides on healthy eating habits for sustainable results.', imageUrl: 'ram 11.jpg' },
            { id: 3, name: 'Coach Sachin', specialty: 'Trainer', bio: 'Gym trainer, Bulking expert.', imageUrl: 'sachin.jpg' },
        ];
